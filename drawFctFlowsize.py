...
schemes = {
    ...
    'ConWeave': {'file': './mix/output/conweave_fat4_irn2_pfc0/339866944_out_fct.txt',                  'color': '#8c564b', 'linestyle': '-',  'marker': ''},
